...
export const translations = {
  en: {
    ...
    capture_subtitle:
      "Track merchandise prices while moving across stores in Japan.",
    capture_header_new_price: "New Price",
    capture_header_new_entry: "New Entry",
    capture_step_product: "Step 1: Product",
    capture_step_price_store: "Step 2: Price + Store",
    capture_next_step: "Next",
    capture_prev_step: "Back",
    capture_add_product: "Add Product",
    capture_edit_product: "Edit Product",
    capture_selected_product: "Selected Product",
    capture_select_product_hint: "Select a product to continue.",
    capture_select_product_first: "Choose a product before saving.",
    capture_price_input: "Price / Store",
    ...
    notes: "Notes",
    capture_notes_placeholder:
      "Add details about shelf location or specific discount conditions...",
    detail_updated_title: "Updated",
    detail_updated_body: "The entry was updated. Compare and history now reflect the latest data.",
    detail_updated_status: "Saved changes for this entry.",
    ...
    location_required_hint:
      "Select the store location on map before saving this price.",
    ...
    map_selected_status:
      "Location selected from map. You can still edit fields before saving.",
    ...
    clear_nickname_body:
      "This store already has a nickname. Save without nickname and remove it?",
    ...
    compare_subtitle:
      "Compare item prices by area, then revisit the best store based on price and distance.",
    compare_header_title: "Compare Prices",
    compare_current_item: "Comparing",
    compare_best_value: "BEST VALUE",
    compare_loading: "Loading latest rankings...",
    compare_empty_title: "No comparisons yet",
    compare_empty_body:
      "Capture at least one product across multiple stores to see rankings.",
    compare_distance_unavailable: "Distance unavailable",
    compare_navigate: "Navigate",
    compare_nav_pending:
      "Navigation handoff is not connected yet in this build.",
    navigation_open_failed:
      "Could not open a map app for directions. Please check app availability.",
    ...
    location_using:
      "Using your location near {{area}}. Distances update automatically for recommendations.",
    merchandise_section: "Merchandise",
    city_area_section: "City Area",
    all_areas: "All Areas",
    no_item_selected: "No item selected",
    no_item_selected_body:
      "Add at least one price entry in Capture to begin comparisons.",
    best_store_now: "Best Store Now",
    best_store_meta: "{{product}} · {{price}} · {{area}}",
    no_comparisons: "No comparisons yet",
    no_comparisons_body:
      "Try another city area or capture this item at multiple stores to unlock ranking.",
    ...
    detail_missing_params_body:
      "Return to Compare and open a valid price tile.",
    ...
    detail_delete_confirm_body: "Delete this entry? This action cannot be undone.",
    ...
    product_form_title_create: "Add Product",
    product_form_title_edit: "Edit Product",
    product_form_image_label: "Product Image (Optional)",
    product_form_image_pick_library: "Pick from Library",
    product_form_image_take_photo: "Take Photo",
    product_form_image_remove: "Remove Image",
    product_form_name_label: "Product Name",
    product_form_note_label: "Note (Optional)",
    product_form_name_placeholder: "Enter product name",
    product_form_note_placeholder: "Add a short note about this product",
    product_form_image_permission_denied: "Please allow photo access to upload a product image.",
    product_form_image_processing_failed: "Could not process the selected image.",
    product_form_image_too_large: "Image is still too large after compression. Choose a smaller one.",
    product_form_image_selected_status: "Product image selected.",
    product_form_image_removed_status: "Product image removed.",
    product_form_create: "Create Product",
    product_form_update: "Update Product",
    product_form_not_found: "Product not found.",
    product_form_name_required: "Product name is required.",
    product_form_note_too_long: "Product note must be 140 characters or fewer.",
    product_form_created_status: "Product created.",
    product_form_created_title: "Product Created",
    product_form_created_body: "Product has been saved. You can now log prices for it.",
    product_form_updated_status: "Product updated.",
    product_form_updated_title: "Product Updated",
    product_form_updated_body: "Product details were saved.",
    compare_edit_product: "Edit Product",
    compare_edit_product_a11y: "Open product edit form",

    history_title: "Price History",
    history_subtitle:
      "Audit recent captures and confirm confidence before purchase.",
    ...
    search_missing_key:
      "Search unavailable (missing Google Places key). Move pin to select location.",
    search_quota: "Search quota reached. Move pin to select location.",
    search_denied:
      "Search denied by Google API key settings. Use pin selection or fix key restrictions/billing.",
    search_unavailable:
      "Search unavailable right now. Move pin to select location.",
    ...
    profile_placeholder_body:
      "Saved stores, shopping preferences, and account settings will appear here.",
  },
  ko: {
    tabs_home: "홈",
    tabs_capture: "기록",
    ...
    capture_step_product: "1단계: 상품",
    capture_step_price_store: "2단계: 가격 + 매장",
    capture_next_step: "다음",
    capture_prev_step: "뒤로",
    capture_add_product: "상품 추가",
    capture_edit_product: "상품 편집",
    capture_selected_product: "선택한 상품",
    capture_select_product_hint: "계속하려면 상품을 먼저 선택해 주세요.",
    capture_select_product_first: "저장하려면 상품을 먼저 선택해 주세요.",
    capture_price_input: "가격 / 매장",
    ...
    select_store_first_hint:
      "입력을 계속하려면 먼저 매장/장소를 선택해 주세요.",
    store_nickname_placeholder: "이 매장에 사용할 별칭을 입력하세요",
    loading_recent_stores: "최근 매장을 불러오는 중...",
    no_recent_stores:
      "저장된 매장이 아직 없어요. 먼저 새 장소를 추가해 주세요.",
    pick_on_map: "지도에서 선택",
    ...
    notes: "메모",
    capture_notes_placeholder:
      "진열 위치나 할인 조건 등의 메모를 남겨보세요...",
    detail_updated_title: "수정 완료",
    detail_updated_body: "항목이 수정됐습니다. 비교/이력에서 최신 정보로 반영됩니다.",
    detail_updated_status: "수정된 항목을 저장했습니다.",
    capture_share_hint: "가격 데이터는 익명으로 커뮤니티와 공유됩니다.",
    capture_detected_hint: "바코드 스캔으로 상품을 인식했어요.",
    location_required_hint:
      "가격 저장 전에 지도에서 매장 위치를 선택해 주세요.",
    observed_at: "관찰 날짜",
    preview: "미리보기",
    save_entry: "저장",
    saving: "저장 중...",
    ...
    map_selected_status:
      "지도에서 위치를 선택했어요. 저장 전까지 수정할 수 있어요.",
    ...
    validation_system_store_required:
      "장소를 선택해 매장 이름을 설정해 주세요.",
    ...
    clear_nickname_body:
      "이 매장에는 기존 별칭이 있어요. 별칭 없이 저장하고 삭제할까요?",
    ...
    detail_missing_params_body:
      "비교 화면으로 돌아가 유효한 가격 타일을 다시 열어 주세요.",
    ...
    detail_delete_confirm_body: "이 항목을 삭제할까요? 되돌릴 수 없습니다.",
    detail_edit_pending: "수정 플로우는 다음 업데이트에서 연결될 예정이에요.",
    detail_delete_pending: "삭제 플로우는 다음 업데이트에서 연결될 예정이에요.",
    product_form_title_create: "상품 추가",
    product_form_title_edit: "상품 수정",
    product_form_image_label: "상품 이미지 (선택)",
    product_form_image_pick_library: "앨범에서 선택",
    product_form_image_take_photo: "사진 촬영",
    product_form_image_remove: "이미지 삭제",
    product_form_name_label: "상품명",
    product_form_note_label: "메모 (선택)",
    product_form_name_placeholder: "상품명을 입력하세요",
    product_form_note_placeholder: "상품에 대한 간단한 메모를 입력하세요",
    product_form_image_permission_denied: "상품 이미지를 업로드하려면 사진 접근 권한이 필요해요.",
    product_form_image_processing_failed: "선택한 이미지를 처리하지 못했어요.",
    product_form_image_too_large: "압축 후에도 이미지가 너무 커요. 더 작은 이미지를 선택해 주세요.",
    product_form_image_selected_status: "상품 이미지가 선택되었어요.",
    product_form_image_removed_status: "상품 이미지가 삭제되었어요.",
    product_form_create: "상품 생성",
    product_form_update: "상품 업데이트",
    product_form_not_found: "상품을 찾을 수 없어요.",
    product_form_name_required: "상품명을 입력해 주세요.",
    product_form_note_too_long: "메모는 최대 140자까지 입력할 수 있어요.",
    product_form_created_status: "상품이 생성되었어요.",
    product_form_created_title: "상품 생성 완료",
    product_form_created_body: "상품이 저장되었고 이제 가격을 기록할 수 있어요.",
    product_form_updated_status: "상품이 업데이트되었어요.",
    product_form_updated_title: "상품 수정 완료",
    product_form_updated_body: "상품 정보가 저장되었어요.",
    compare_edit_product: "상품 수정",
    compare_edit_product_a11y: "상품 수정 화면 열기",
    ...
    search_missing_key:
      "Google Places 키가 없어 검색할 수 없어요. 핀으로 위치를 선택하세요.",
    search_quota: "검색 할당량이 초과되었어요. 핀으로 위치를 선택하세요.",
    search_denied:
      "Google API 키 설정으로 검색이 거부되었어요. 핀 선택을 사용하거나 키 설정/결제를 확인하세요.",
    search_unavailable:
      "검색을 지금 사용할 수 없어요. 핀으로 위치를 선택하세요.",
    ...
    profile_placeholder_body:
      "저장한 매장, 쇼핑 선호도, 계정 설정이 여기에 표시될 예정입니다.",
  },
} as const;
