...
import { useCompareScreenController } from './hooks/useCompareScreenController';
...
export const CompareScreenContainer = () => {
  ...
  const selectedProductSubtitle = useMemo(() => {
    const productWithMetadata = selectedProduct as
      | (ProductOption & {
          subtitle?: string;
          packageInfo?: string;
        })
      | null;
    const subtitle =
      productWithMetadata?.subtitle ?? productWithMetadata?.packageInfo ?? null;
        ...
        <View style={[styles.frame, { width: frameWidth }]}>
          ...
          >
            <View style={styles.contentColumn}>
              ...
              {!selectedProduct ? (
                <CompareEmptyStateCard
                  title={t('no_item_selected')}
                  body={t('no_item_selected_body')}
                />
              ) : null}
